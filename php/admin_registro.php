...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Validación de rol_id
    if (!in_array($rol_id, ["1", "2", "3", "4", "5"])) {
        header("Location: ../index.html?error=" . urlencode('Rol inválido'));
        exit();
    }
    ...
    // Opcional: Hashear la contraseña para mayor seguridad
    ...
    if ($stmt->execute()) {
        header("Location: ../templates/admin_index.html?success=" . urlencode('Registro exitoso'));
    } else {
